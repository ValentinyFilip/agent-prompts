...
1. **Create `requirements.original.md`**: Inside `.specs/<feature-name>/`, write the requirements document with the ASD-STE100 rules in `.clinerules/language-style.md`. Include an Introduction, Glossary, and EARS Requirements Table:
...
3. **Compress to `requirements.md`**: Once approved, execute `/steering-manager compress .specs/<feature-name>/requirements.original.md` to generate the corresponding Caveman-shorthand `requirements.md` file.
...
1. **Create `design.original.md`**: Inside `.specs/<feature-name>/`, write the design document with the ASD-STE100 rules in `.clinerules/language-style.md`. Include an Architecture Overview, an ASCII Flowchart, Components & Interfaces, Data Models, Correctness Properties, and an Error Handling Matrix.
...
3. **Compress to `design.md`**: Once approved, execute `/steering-manager compress .specs/<feature-name>/design.original.md` to generate the corresponding Caveman-shorthand `design.md` file.
...
3. **Compress to `tasks.md`**: Once approved, execute `/steering-manager compress .specs/<feature-name>/tasks.original.md` to generate the corresponding Caveman-shorthand `tasks.md` file.
