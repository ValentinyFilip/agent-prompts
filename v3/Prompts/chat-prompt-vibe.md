...
4. **Never Compress Untouchables**: Never strip, shorten, or alter a file path, identifier, class/function/table name, command, product name, configuration key, or quoted error message. Copy each of these exactly as given.
5. Task/Fix Compression Example:
...
6. Verification Compression Example:
...
Ready? Please ask me to paste the raw bug report, styling tweak, or task description.
